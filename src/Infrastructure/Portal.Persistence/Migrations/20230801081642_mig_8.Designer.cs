...
namespace Portal.Persistence.Migrations
{
    ...
    [Migration("20230801081642_mig_8")]
    partial class mig_8
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommentEducation", b =>
                {
                    b.Property<int>("CommentsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CommentsId", "EducationsId");

                    b.HasIndex("EducationsId");

                    b.ToTable("CommentEducation");
                });

            modelBuilder.Entity("CommentSeminar", b =>
                {
                    b.Property<int>("CommentsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CommentsId", "SeminarsId");

                    b.HasIndex("SeminarsId");

                    b.ToTable("CommentSeminar");
                });

            modelBuilder.Entity("CommentWorkshop", b =>
                {
                    b.Property<int>("CommentsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CommentsId", "WorkshopsId");

                    b.HasIndex("WorkshopsId");

                    b.ToTable("CommentWorkshop");
                });
            ...
            modelBuilder.Entity("BlogComment", b =>
                {
                    b.HasOne("Portal.Domain.Entities.Blog", null)
                        .WithMany()
                        .HasForeignKey("BlogsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Portal.Domain.Entities.Comment", null)
                        .WithMany()
